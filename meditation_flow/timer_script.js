...
function generateTime(timer_length) {
	...
	document.getElementById("timer_control_9809403065").innerHTML = "0" + minutes + ":" + seconds ;
}
...
var x = function updateTimer() {     
	...
	if (time < 0) {         
		...
		document.getElementById("timer_control_9809403065").innerHTML = "meditate again";
		...
		document.getElementById("timer_control_9809403065").style.cursor= "pointer";
...
var start = function startTimer() {
	...
	document.getElementById("timer_control_9809403065").style.cursor= "initial";
	interval = setInterval(x, 1000);
}

document.getElementById("timer_control_9809403065").addEventListener("click", start);
